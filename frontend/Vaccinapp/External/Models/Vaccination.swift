...
//
//  Renamed Vaccination to VaccinationDTO for namespace reasons - Julian Veerkamp
import Foundation

public class VaccinationDTO: Codable {
...
extension VaccinationDTO: Hashable {
    public func hash(into hasher: inout Hasher) {
        hasher.combine(ci)
    }

    public static func == (lhs: VaccinationDTO, rhs: VaccinationDTO) -> Bool {
        lhs.ci == rhs.ci
    }
}

extension VaccinationDTO: Comparable {
    /// Sort by dose number
    public static func < (lhs: VaccinationDTO, rhs: VaccinationDTO) -> Bool {
        lhs.dn > rhs.dn
    }
...
public extension VaccinationDTO {
