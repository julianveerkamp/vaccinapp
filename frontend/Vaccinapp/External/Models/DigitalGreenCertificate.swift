...
public struct DigitalGreenCertificate: Codable {
    ...
    public init(nam: Name, dob: Date? = nil, dobString: String? = nil, v: [VaccinationDTO]? = nil, t: [Test]? = nil, r: [Recovery]? = nil, ver: String) {
        self.nam = nam
        self.dob = dob
    ...
    public init(from decoder: Decoder) throws {
        ...
        v = try? values.decode([VaccinationDTO].self, forKey: .v)
